...
export default function HomeDay(props: Props) {
    ...
    const podatki = [
        { name: 'Poraba', usage: dayUsage, fill: "#023e8a" },
        { name: 'Povprečna poraba', usage: avgUsage, fill: "yellow" },
    ];
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                        <DatePicker label="Datum" defaultValue={dayjs("2023-02-28")} onChange={handleDateChange} />
                ...
                <div style={{ display: "flex", gap: "4vh", marginTop: "6vh", justifyContent: "center" }}>
                    ...
                    >
                        ...
                        <ResponsiveContainer  height={300}>                
                                 <BarChart width={550} height={300} data={podatki}>
                                <Bar dataKey="usage" />
                                <XAxis dataKey="name" />
                                <YAxis unit='kWh' />
                                <Tooltip/>
